...
Version  : 8.2.1
Release  : 8
URL      : https://files.pythonhosted.org/packages/cf/47/53ef6d16f4cc0c8440edecc5cd51f1c8b9d1f9173b9091418cb4e2ac8a25/mkdocs-material-8.2.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/cf/47/53ef6d16f4cc0c8440edecc5cd51f1c8b9d1f9173b9091418cb4e2ac8a25/mkdocs-material-8.2.1.tar.gz
...
%prep
%setup -q -n mkdocs-material-8.2.1
cd %{_builddir}/mkdocs-material-8.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645130270
...
cp %{_builddir}/mkdocs-material-8.2.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/c04750a54aad0aac5aa08619287d869ee66df4b4
cp %{_builddir}/mkdocs-material-8.2.1/material/.icons/fontawesome/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/80fb80e63f6d77304c296cefd98e3b5b6ad6fdc9
cp %{_builddir}/mkdocs-material-8.2.1/material/.icons/material/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/b0e637b59cdb1bcaf705cb3d90e6c4573dcd363e
cp %{_builddir}/mkdocs-material-8.2.1/material/.icons/octicons/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/9ac1a9e1c7eee2d1d386714412f99d7b1fca0681
