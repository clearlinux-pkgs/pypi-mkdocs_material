...
Version  : 8.3.5
Release  : 29
URL      : https://files.pythonhosted.org/packages/e9/0f/4a0328ca21b8e4f61dd7e6243b6a0da23b6dfd79271963399fb2b93c2ecf/mkdocs-material-8.3.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/e9/0f/4a0328ca21b8e4f61dd7e6243b6a0da23b6dfd79271963399fb2b93c2ecf/mkdocs-material-8.3.5.tar.gz
...
%prep
%setup -q -n mkdocs-material-8.3.5
cd %{_builddir}/mkdocs-material-8.3.5
pushd ..
cp -a mkdocs-material-8.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655314105
...
cp %{_builddir}/mkdocs-material-8.3.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/c04750a54aad0aac5aa08619287d869ee66df4b4
cp %{_builddir}/mkdocs-material-8.3.5/material/.icons/fontawesome/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/80fb80e63f6d77304c296cefd98e3b5b6ad6fdc9
cp %{_builddir}/mkdocs-material-8.3.5/material/.icons/material/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/b0e637b59cdb1bcaf705cb3d90e6c4573dcd363e
cp %{_builddir}/mkdocs-material-8.3.5/material/.icons/octicons/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/9ac1a9e1c7eee2d1d386714412f99d7b1fca0681
