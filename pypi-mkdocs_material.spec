...
Source0  : https://files.pythonhosted.org/packages/78/cb/749987f85bf26d03b4a83649d727650a4a8d52a5ada125de496de9616904/mkdocs-material-8.1.10.tar.gz
...
%prep
%setup -q -n mkdocs-material-8.1.10
cd %{_builddir}/mkdocs-material-8.1.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644179685
...
cp %{_builddir}/mkdocs-material-8.1.10/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/c04750a54aad0aac5aa08619287d869ee66df4b4
cp %{_builddir}/mkdocs-material-8.1.10/material/.icons/material/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/b0e637b59cdb1bcaf705cb3d90e6c4573dcd363e
