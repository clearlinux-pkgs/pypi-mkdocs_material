...
Version  : 8.3.9
Release  : 33
URL      : https://files.pythonhosted.org/packages/82/68/24fd0698479ff3ad1b222454b21996176f323c6aa07b92b7abac8d92cbc3/mkdocs-material-8.3.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/82/68/24fd0698479ff3ad1b222454b21996176f323c6aa07b92b7abac8d92cbc3/mkdocs-material-8.3.9.tar.gz
...
%prep
%setup -q -n mkdocs-material-8.3.9
cd %{_builddir}/mkdocs-material-8.3.9
pushd ..
cp -a mkdocs-material-8.3.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657036248
...
cp %{_builddir}/mkdocs-material-8.3.9/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/c04750a54aad0aac5aa08619287d869ee66df4b4
cp %{_builddir}/mkdocs-material-8.3.9/material/.icons/fontawesome/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/80fb80e63f6d77304c296cefd98e3b5b6ad6fdc9
cp %{_builddir}/mkdocs-material-8.3.9/material/.icons/material/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/b0e637b59cdb1bcaf705cb3d90e6c4573dcd363e
cp %{_builddir}/mkdocs-material-8.3.9/material/.icons/octicons/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/9ac1a9e1c7eee2d1d386714412f99d7b1fca0681
