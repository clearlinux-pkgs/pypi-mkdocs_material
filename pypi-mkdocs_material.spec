...
Version  : 8.2.8
Release  : 15
URL      : https://files.pythonhosted.org/packages/57/e9/7ba0cbfce133a817e985386a93540a484fdcefb8061027484c3891eaffe4/mkdocs-material-8.2.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/57/e9/7ba0cbfce133a817e985386a93540a484fdcefb8061027484c3891eaffe4/mkdocs-material-8.2.8.tar.gz
...
%prep
%setup -q -n mkdocs-material-8.2.8
cd %{_builddir}/mkdocs-material-8.2.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648415909
...
cp %{_builddir}/mkdocs-material-8.2.8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/c04750a54aad0aac5aa08619287d869ee66df4b4
cp %{_builddir}/mkdocs-material-8.2.8/material/.icons/fontawesome/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/80fb80e63f6d77304c296cefd98e3b5b6ad6fdc9
cp %{_builddir}/mkdocs-material-8.2.8/material/.icons/material/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/b0e637b59cdb1bcaf705cb3d90e6c4573dcd363e
cp %{_builddir}/mkdocs-material-8.2.8/material/.icons/octicons/LICENSE %{buildroot}/usr/share/package-licenses/pypi-mkdocs_material/9ac1a9e1c7eee2d1d386714412f99d7b1fca0681
